...
function playerMove(){
    $(document).on("click", "#table td", function(e) {
        ...
        var rowidx=Math.floor(player_move/7);
        var colidx=player_move%7;
        ...
        var rowidx=Math.floor(computer_move/7);
        var colidx=computer_move%7;
...
function checkIfRubricEmpty(mBoard,position){
    var rowidx=Math.floor(position/7);
    var colidx=position%7;
...
function drawEmpty(position_idx){
    var rowidx=Math.floor(position_idx/7);
    var colidx=position_idx%7;
